(deftheme czc-darkula
  "Created 2014-09-04.")

(custom-theme-set-faces
 'czc-darkula
 '(default ((t (:inherit nil :stipple nil :background "#000000" :foreground "#A9B7C6" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry nil :family "Ubuntu Mono"))))
 ...
 '(font-lock-preprocessor-face ((t (:weight normal :slant normal :underline nil :inverse-video nil :foreground "#A9CDC6" :inherit (font-lock-builtin-face)))))
