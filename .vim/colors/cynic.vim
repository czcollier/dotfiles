...
let g:colors_name = "cynic"

hi Normal       guifg=Honeydew2 guibg=Black
...
hi String       gui=NONE guifg=LightGray guibg=bg
hi Special      gui=NONE guifg=SlateGrey guibg=bg
hi Statement    gui=NONE guifg=LightBlue1 guibg=bg
hi Operator     gui=NONE guifg=NavajoWhite1 guibg=bg
...
hi Comment      gui=NONE guifg=SlateGrey guibg=bg
hi Identifier   gui=NONE guifg=Honeydew2 guibg=bg
hi PreProc      gui=NONE guifg=LightBlue4 guibg=bg
hi Type         gui=NONE guifg=LightSteelBlue1 guibg=bg
