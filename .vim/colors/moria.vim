...
if &background == "dark"
    ...
    if s:moria_monochrome == 1
        ...
        hi MoreMsg guibg=bg guifg=#b6b6b6 gui=NONE
        hi NonText ctermfg=DarkGray guibg=bg guifg=#a0a0a0 gui=NONE
        ...
        hi StatusLine ctermbg=LightGray ctermfg=Black guibg=#4c4c4c guifg=fg gui=NONE
        ...
        hi MoreMsg guibg=bg guifg=#97abd5 gui=NONE
        hi NonText ctermfg=DarkGray guibg=bg guifg=#8fa5d1 gui=NONE
    ...
    hi DiffText guibg=#0000cd guifg=fg gui=NONE
    ...
    hi Question guibg=bg guifg=#e8b87e gui=NONE
    ...
    hi Title ctermbg=Black ctermfg=White guifg=fg gui=NONE
    if version >= 700
    ...
    hi VisualNOS ctermbg=DarkGray ctermfg=Black guibg=bg guifg=#a0a0a0 gui=NONE,underline
    hi WarningMsg guibg=bg guifg=#ee2c2c gui=NONE
    hi WildMenu guibg=#e0e000 guifg=#000000 gui=NONE
    ...
    hi htmlBold ctermbg=Black ctermfg=White guibg=bg guifg=fg gui=NONE
    hi htmlBoldItalic ctermbg=Black ctermfg=White guibg=bg guifg=fg gui=NONE,italic
    hi htmlBoldUnderline ctermbg=Black ctermfg=White guibg=bg guifg=fg gui=NONE,underline
    hi htmlBoldUnderlineItalic ctermbg=Black ctermfg=White guibg=bg guifg=fg gui=NONE,underline,italic
...
elseif &background == "light"
    ...
    if s:moria_monochrome == 1
        ...
        hi Folded guibg=#cfcfcf guifg=#404040 gui=NONE
        hi LineNr guifg=#7a7a7a gui=none
        hi MoreMsg guibg=bg guifg=#505050 gui=NONE
        ...
        hi StatusLine ctermbg=Black ctermfg=White guibg=#a0a0a0 guifg=fg gui=NONE
        ...
        hi Folded guibg=#cfcfcf guifg=#25365a gui=NONE
        hi LineNr guifg=#375288 gui=none
        hi MoreMsg guibg=bg guifg=#2f4471 gui=NONE
        ...
        hi StatusLine ctermbg=Black ctermfg=White guibg=#8fa5d1 guifg=fg gui=NONE
    ...
    hi ModeMsg ctermbg=White ctermfg=Black guibg=bg guifg=fg gui=NONE
    hi PmenuSel guibg=#ffff00 guifg=#000000 gui=none
    hi Question guibg=bg guifg=#813f11 gui=NONE
    ...
    hi VisualNOS ctermbg=DarkGray ctermfg=Black guibg=bg guifg=#a0a0a0 gui=NONE,underline
    hi WarningMsg guibg=bg guifg=#ee2c2c gui=NONE
    hi WildMenu guibg=#ffff00 guifg=fg gui=NONE
    ...
    hi htmlBold ctermbg=White ctermfg=Black guibg=bg guifg=fg gui=NONE
    hi htmlBoldItalic ctermbg=White ctermfg=Black guibg=bg guifg=fg gui=NONE,italic
    hi htmlBoldUnderline ctermbg=White ctermfg=Black guibg=bg guifg=fg gui=NONE,underline
    hi htmlBoldUnderlineItalic ctermbg=White ctermfg=Black guibg=bg guifg=fg gui=NONE,underline,italic
