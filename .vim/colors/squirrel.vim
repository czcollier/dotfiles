" Vim color file
" Maintainer:   Chris Collier (czcollier at gmail dot com)
" Last Change:  October 4 2011
"
" squirrel.vim - a modified version of Wombat256 by David Liang 
"
set background=dark
...
call <SID>X("CursorLine",	"",			"22221e",	"none")
...
call <SID>X("VertSplit",	"444444",	"444443",	"none")
...
call <SID>X("String",		"85A474",	"",			"italic")
